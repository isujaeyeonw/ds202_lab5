...
<!-- comments/ edits from jay -->
<!-- Jaeyon, you did a great job on this!! I have been struggling with my joins and getting my maps to work. -->

<!-- the only suggestion I could make would be using a local copy of the data instead of loading it off of prof's github everytime! -->
...
```{r}
# If I wanted to add state abb in the maps
# states_abb
#states_abb = read.csv("statelatlong.csv")

#states_abb = states_abb %>%
#  filter(!State %in% c('AK', 'HI'))

#  geom_text(data = states_abb, 
#            aes(x = Longitude, y = Latitude, label = State), color = 'white') +



# Location of the text
#acc_season_state_loc = acc_season_state_text %>% 
#  group_by(STATE) %>% 
#  summarise(long = mean(long, na.rm = TRUE), lat = mean(lat, na.rm = TRUE))
```
